...
def deepModelPremium(N=None, d=2, m=8, eps=0.0, useBatchNorm=False, \
    ...
    premium = Dense(1, activation='linear')(price)
    ...
    for j in range(N+1):
        if j<N:
            ...
            wealth = Add()([wealth, premium])
    
    return Model(inputs=inputs, outputs=[wealth, premium])
