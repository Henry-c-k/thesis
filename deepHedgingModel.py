...
"""
originally taken from : https://github.com/YuMan-Tam/deep-hedging and the changed
heavily for our purposes
"""
...
def deepModel(N=None, d=2, m=8, eps=0.0, useBatchNorm=False, \
